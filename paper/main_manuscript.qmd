...
Figures 6 and 7 display linear models that depict cattle depredation trends and wolf population respectively. Table 1 provides information for three models I constructed: Model 1 concerns cattle depredation, Model 2 concerns wolf population, and Model 3 concerns overall cattle mortality. 
...
This longitudinal analysis has sought to broaden the temporal scope of analyzing wolf depredation on cattle and question how big of an impact wolves actually have on the cattle industry and whether an increasing wolf population causes more cattle depredation.
