...
Instances of wolf depredations are, on average in these states, on the rise while wolf numbers are remaining steady, refuting the idea that wolf depredations increase in tandem with population. Wolf population dynamics are not enough to explain increases in depredation events on cattle. (insert language about wolf population being blamed on depredation above in intro) 


# Conclusions


This research has clearly shown that in the states of Montana, Oregon, Washington and Wyoming wolves are not a major source of economic pressure on cattle industries. 

Future research should look into 

A question remains: why are cases of wolf depredation on cattle increasing despite a relatively stable wolf population? 

There is a range of other proposed reasons for wolf depredation including: an increase of lethal control of wolf population (Santiago-Avila), climate change (need citation), changes in wolf behavior (need citation) and changes in human behavior (need citation). I would also hypothesize that changes in reporting at the state agency level could affect wolf depredation reports. Research that delves into these potential causes of wolf depredation on cattle could be of great use to government agencies, ranching operations, conservation organizations and policy makers invested in fostering best practices and protecting the lives of cattle and wolves through conflict prevention. 
