...
#data shows that wolves aren't that dangerous to cattle-- depredation is always 
#under 100 

#let's make a model

model1 <- lm(all_combo$wolf_cattle_kills~all_combo$wolf_pop)
...
coef(lm(year~wolf_cattle_kills, data=all_combo))
